...
## 判断输出格式（严格执行）
- **PDF 原文中的文档表格**一律使用 HTML `<table>` 语法输出，包括简单表格、复杂表格、跨页续表、无表头表格。
- **严禁**使用 Markdown `|` 表格语法输出 PDF 原文中的文档表格。
- 流程图补充说明中的 Mermaid 图、节点列表等生成型辅助结构不属于 PDF 原文文档表格，可按下方 Flowchart / Architecture Rules 的格式输出。
